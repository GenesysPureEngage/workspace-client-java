...
public class CampaignStatus {
  ...
  public CampaignStatus code(Integer code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public CampaignStatus message(String message) {
   ...
   * @return message
  **/
  @ApiModelProperty(value = "Provides general information when a request returns an error")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.code, campaignStatus.code) &&
        Objects.equals(this.message, campaignStatus.message);
  }
