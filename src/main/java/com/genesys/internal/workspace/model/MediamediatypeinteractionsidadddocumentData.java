...
public class MediamediatypeinteractionsidadddocumentData {
   ...
   * @return documentId
  **/
  @ApiModelProperty(required = true, value = "The id of the document to be added.")
   ...
   * @return size
  **/
  @ApiModelProperty(value = "The size of the document to be added.")
   ...
   * @return mime
  **/
  @ApiModelProperty(value = "The mime type of the document to be added.")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The name of the document to be added.")
