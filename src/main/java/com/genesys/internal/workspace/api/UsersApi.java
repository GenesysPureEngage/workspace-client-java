...
public class UsersApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse getUsers(String searchTerm, String sort, BigDecimal limit, BigDecimal offset) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = getUsersWithHttpInfo(searchTerm, sort, limit, offset);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> getUsersWithHttpInfo(String searchTerm, String sort, BigDecimal limit, BigDecimal offset) throws ApiException {
        com.squareup.okhttp.Call call = getUsersValidateBeforeCall(searchTerm, sort, limit, offset, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUsersAsync(String searchTerm, String sort, BigDecimal limit, BigDecimal offset, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
