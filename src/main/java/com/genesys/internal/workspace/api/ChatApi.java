...
import com.genesys.internal.workspace.model.UploadData;
...
public class ChatApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call cancelConsultationChatCall(String id, CancelConsultData cancelConsultData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call cancelConsultationChatValidateBeforeCall(String id, CancelConsultData cancelConsultData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = cancelConsultationChatCall(id, cancelConsultData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse cancelConsultationChat(String id, CancelConsultData cancelConsultData) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> cancelConsultationChatWithHttpInfo(String id, CancelConsultData cancelConsultData) throws ApiException {
        com.squareup.okhttp.Call call = cancelConsultationChatValidateBeforeCall(id, cancelConsultData, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call cancelConsultationChatAsync(String id, CancelConsultData cancelConsultData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = cancelConsultationChatValidateBeforeCall(id, cancelConsultData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param id The ID of the chat interaction. (required)
     * @param uploadData Request parameters. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call uploadFileCall(String id, UploadData uploadData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = uploadData;

        // create path and map variables
        String localVarPath = "/media/chat/interactions/{id}/upload-file"
            .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call uploadFileValidateBeforeCall(String id, UploadData uploadData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = uploadFileCall(id, uploadData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse uploadFile(String id, UploadData uploadData) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = uploadFileWithHttpInfo(id, uploadData);
        return resp.getData();
    }
    ...
    /**
     * Share a document (asynchronously)
     * Share a document with participants
     * @param id The ID of the chat interaction. (required)
     * @param uploadData Request parameters. (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call uploadFileAsync(String id, UploadData uploadData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = uploadFileValidateBeforeCall(id, uploadData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
