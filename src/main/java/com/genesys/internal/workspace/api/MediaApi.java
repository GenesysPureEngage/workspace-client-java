...
public class MediaApi {
     ...
     */
    public com.squareup.okhttp.Call acceptCall(String mediatype, String id, AcceptData3 acceptData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call acceptValidateBeforeCall(String mediatype, String id, AcceptData3 acceptData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     */
    public ApiSuccessResponse accept(String mediatype, String id, AcceptData3 acceptData) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> acceptWithHttpInfo(String mediatype, String id, AcceptData3 acceptData) throws ApiException {
    ...
    /**
     * Accept an interaction (asynchronously)
     * Accept the specified interaction.
     * @param mediatype The media channel. (required)
     * @param id The ID of the interaction to accept. (required)
     * @param acceptData Request parameters. (optional)
     ...
     */
    public com.squareup.okhttp.Call acceptAsync(String mediatype, String id, AcceptData3 acceptData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
    ...
    /**
     * Add a document
     * Add a document to the specified interaction.
     * @param mediatype The media channel. (required)
     * @param id The ID of the interaction. (required)
     * @param addDocumentData  (required)
     * @return ApiSuccessResponse
    ...
    /**
     * Get an attachment
     * Get the specified  attachment from the interaction
     * @param mediatype The media channel. (required)
     * @param id The ID of the interaction. (required)
     * @param documentId The ID of the document. (required)
     * @return String
     ...
     * Pull the specified interaction from a workbin.
     * @param mediatype The media channel. (required)
     * @param id The ID of the interaction. (required)
     * @param pullInteractionFromWorkbinData  (optional)
     * @return ApiSuccessResponse
    ...
    /**
     * Reject an interaction (asynchronously)
     * Reject the specified interaction.
     * @param mediatype The media channel. (required)
     * @param id The ID of the interaction to reject. (required)
     * @param rejectData Request parameters. (optional)
     ...
     * @param mediatype The media channel. (required)
     * @param id The ID of the interaction. (required)
     * @param documentId The ID of the document to remove. (required)
     ...
     * Remove the specified attachment from the interaction.
     * @param mediatype The media channel. (required)
     * @param id The ID of the interaction. (required)
     * @param documentId The ID of the document to remove. (required)
     * @param removeAttachmentData  (optional)
    ...
    /**
     * Remove an attachment (asynchronously)
     * Remove the specified attachment from the interaction.
     * @param mediatype The media channel. (required)
     * @param id The ID of the interaction. (required)
     * @param documentId The ID of the document to remove. (required)
