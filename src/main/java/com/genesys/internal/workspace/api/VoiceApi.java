...
import com.genesys.internal.workspace.model.SetFocusTimeData;
...
public class VoiceApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call attachUserDataCall(String id, UserDataOperationId userData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call attachUserDataValidateBeforeCall(String id, UserDataOperationId userData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse attachUserData(String id, UserDataOperationId userData) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call attachUserDataAsync(String id, UserDataOperationId userData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call cancelForwardCall(CancelForwardBody cancelForwardBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = cancelForwardBody;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call cancelForwardValidateBeforeCall(CancelForwardBody cancelForwardBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = cancelForwardCall(cancelForwardBody, progressListener, progressRequestListener);
        return call;
    ...
    public ApiSuccessResponse cancelForward(CancelForwardBody cancelForwardBody) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = cancelForwardWithHttpInfo(cancelForwardBody);
        return resp.getData();
    }
    ...
    public ApiResponse<ApiSuccessResponse> cancelForwardWithHttpInfo(CancelForwardBody cancelForwardBody) throws ApiException {
        com.squareup.okhttp.Call call = cancelForwardValidateBeforeCall(cancelForwardBody, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call cancelForwardAsync(CancelForwardBody cancelForwardBody, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = cancelForwardValidateBeforeCall(cancelForwardBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call completeCallCall(String id, UserData userData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = userData;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call completeCallValidateBeforeCall(String id, UserData userData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse completeCall(String id, UserData userData) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> completeCallWithHttpInfo(String id, UserData userData) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call completeCallAsync(String id, UserData userData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
     ...
     * @param loginData  (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call loginVoiceCall(LoginData loginData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call loginVoiceValidateBeforeCall(LoginData loginData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = loginVoiceCall(loginData, progressListener, progressRequestListener);
        return call;

    }

    /**
     * Log in on the voice channel
     * Log in the current agent on the voice channel. When you make this request, Workspace uses the parameters you provided in [/activate-channels](/reference/workspace/Session/index.html#activateChannels). For most applications, you don&#39;t need to worry about logging in the agent on the voice channel because it&#39;s handled by the Workspace API when you call [/activate-channels](/reference/workspace/Session/index.html#activateChannels). However, if you make a [/voice/logout](/reference/workspace/Voice/index.html#logoutVoice) request, you can then use [/voice/login](/reference/workspace/Voice/index.html#loginVoice) to log in the agent on the voice channel. **Note&amp;colon;** This login /logout flow only applies to the voice channel, not to the agent&#39;s session.
     * @param loginData  (optional)
     * @return ApiSuccessResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse loginVoice(LoginData loginData) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = loginVoiceWithHttpInfo(loginData);
        return resp.getData();
    }
    ...
    public ApiResponse<ApiSuccessResponse> loginVoiceWithHttpInfo(LoginData loginData) throws ApiException {
        com.squareup.okhttp.Call call = loginVoiceValidateBeforeCall(loginData, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Log in on the voice channel (asynchronously)
     * Log in the current agent on the voice channel. When you make this request, Workspace uses the parameters you provided in [/activate-channels](/reference/workspace/Session/index.html#activateChannels). For most applications, you don&#39;t need to worry about logging in the agent on the voice channel because it&#39;s handled by the Workspace API when you call [/activate-channels](/reference/workspace/Session/index.html#activateChannels). However, if you make a [/voice/logout](/reference/workspace/Voice/index.html#logoutVoice) request, you can then use [/voice/login](/reference/workspace/Voice/index.html#loginVoice) to log in the agent on the voice channel. **Note&amp;colon;** This login /logout flow only applies to the voice channel, not to the agent&#39;s session.
     * @param loginData  (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call loginVoiceAsync(LoginData loginData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = loginVoiceValidateBeforeCall(loginData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param dndOnBody Request parameters. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call logoutVoiceCall(DndOnBody dndOnBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = dndOnBody;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call logoutVoiceValidateBeforeCall(DndOnBody dndOnBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = logoutVoiceCall(dndOnBody, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<ApiSuccessResponse> logoutVoiceWithHttpInfo(DndOnBody dndOnBody) throws ApiException {
        com.squareup.okhttp.Call call = logoutVoiceValidateBeforeCall(dndOnBody, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call logoutVoiceAsync(DndOnBody dndOnBody, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = logoutVoiceValidateBeforeCall(dndOnBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param id The connection ID of the call. (required)
     * @param pauseRecordingBody Request parameters. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call pauseRecordingCall(String id, PauseRecordingBody pauseRecordingBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = pauseRecordingBody;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call pauseRecordingValidateBeforeCall(String id, PauseRecordingBody pauseRecordingBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = pauseRecordingCall(id, pauseRecordingBody, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse pauseRecording(String id, PauseRecordingBody pauseRecordingBody) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = pauseRecordingWithHttpInfo(id, pauseRecordingBody);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> pauseRecordingWithHttpInfo(String id, PauseRecordingBody pauseRecordingBody) throws ApiException {
        com.squareup.okhttp.Call call = pauseRecordingValidateBeforeCall(id, pauseRecordingBody, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Pause recording on a call (asynchronously)
     * Pause recording on the specified call.
     * @param id The connection ID of the call. (required)
     * @param pauseRecordingBody Request parameters. (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call pauseRecordingAsync(String id, PauseRecordingBody pauseRecordingBody, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = pauseRecordingValidateBeforeCall(id, pauseRecordingBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Redirect a call (asynchronously)
     * Redirect a call to the specified destination.
     * @param id The connection ID of the current call to redirect. (required)
     * @param redirectData  (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call resumeRecordingCall(String id, ResumeRecordingBody resumeRecordingBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = resumeRecordingBody;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call resumeRecordingValidateBeforeCall(String id, ResumeRecordingBody resumeRecordingBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = resumeRecordingCall(id, resumeRecordingBody, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse resumeRecording(String id, ResumeRecordingBody resumeRecordingBody) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> resumeRecordingWithHttpInfo(String id, ResumeRecordingBody resumeRecordingBody) throws ApiException {
        com.squareup.okhttp.Call call = resumeRecordingValidateBeforeCall(id, resumeRecordingBody, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Resume recording a call (asynchronously)
     * Resume recording the specified call.
     * @param id The connection ID of the call. (required)
     * @param resumeRecordingBody Request parameters. (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call resumeRecordingAsync(String id, ResumeRecordingBody resumeRecordingBody, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = resumeRecordingValidateBeforeCall(id, resumeRecordingBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Retrieve a call from hold (asynchronously)
     * Retrieve the specified call from hold.
     * @param id The connection ID of the call. (required)
     * @param retrieveData Request parameters. (optional)
     * @param callback The callback to be executed when the API call finishes
    ...
    /**
     * Send a userEvent event to T-Server (asynchronously)
     * Send EventUserEvent to T-Server with the provided attached data. For details about EventUserEvent, refer to the [*Genesys Events and Models Reference Manual*](https://docs.genesys.com/Documentation/System).
     * @param userEventData The data to send. This is an array of objects with the properties key, type, and value. (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param dndOffBody Request parameters. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call setDNDOffCall(DndOffBody dndOffBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = dndOffBody;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call setDNDOffValidateBeforeCall(DndOffBody dndOffBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = setDNDOffCall(dndOffBody, progressListener, progressRequestListener);
        return call;
    ...
    public ApiSuccessResponse setDNDOff(DndOffBody dndOffBody) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = setDNDOffWithHttpInfo(dndOffBody);
        return resp.getData();
    }
    ...
    public ApiResponse<ApiSuccessResponse> setDNDOffWithHttpInfo(DndOffBody dndOffBody) throws ApiException {
        com.squareup.okhttp.Call call = setDNDOffValidateBeforeCall(dndOffBody, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call setDNDOffAsync(DndOffBody dndOffBody, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = setDNDOffValidateBeforeCall(dndOffBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call setDNDOnCall(DndOnBody1 dndOnBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = dndOnBody;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call setDNDOnValidateBeforeCall(DndOnBody1 dndOnBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = setDNDOnCall(dndOnBody, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse setDNDOn(DndOnBody1 dndOnBody) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = setDNDOnWithHttpInfo(dndOnBody);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> setDNDOnWithHttpInfo(DndOnBody1 dndOnBody) throws ApiException {
        com.squareup.okhttp.Call call = setDNDOnValidateBeforeCall(dndOnBody, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call setDNDOnAsync(DndOnBody1 dndOnBody, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = setDNDOnValidateBeforeCall(dndOnBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for setFocusTimeCall
     * @param id The connection ID of the call. (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call setFocusTimeCallCall(String id, SetFocusTimeData setFocusTimeData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = setFocusTimeData;

        // create path and map variables
        String localVarPath = "/voice/calls/{id}/set-focus-time"
            .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call setFocusTimeCallValidateBeforeCall(String id, SetFocusTimeData setFocusTimeData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling setFocusTimeCall(Async)");
        }
        
        // verify the required parameter 'setFocusTimeData' is set
        if (setFocusTimeData == null) {
            throw new ApiException("Missing the required parameter 'setFocusTimeData' when calling setFocusTimeCall(Async)");
        }
        

        com.squareup.okhttp.Call call = setFocusTimeCallCall(id, setFocusTimeData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> setFocusTimeCallWithHttpInfo(String id, SetFocusTimeData setFocusTimeData) throws ApiException {
        com.squareup.okhttp.Call call = setFocusTimeCallValidateBeforeCall(id, setFocusTimeData, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Set the focus time of call (asynchronously)
     * Set the focus time to the specified call.
     * @param id The connection ID of the call. (required)
     * @param setFocusTimeData Request parameters. (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call setFocusTimeCallAsync(String id, SetFocusTimeData setFocusTimeData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = setFocusTimeCallValidateBeforeCall(id, setFocusTimeData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param id The connection ID of the call. (required)
     * @param startRecordingBody Request parameters. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call startRecordingCall(String id, StartRecordingBody startRecordingBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = startRecordingBody;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call startRecordingValidateBeforeCall(String id, StartRecordingBody startRecordingBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = startRecordingCall(id, startRecordingBody, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse startRecording(String id, StartRecordingBody startRecordingBody) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = startRecordingWithHttpInfo(id, startRecordingBody);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> startRecordingWithHttpInfo(String id, StartRecordingBody startRecordingBody) throws ApiException {
        com.squareup.okhttp.Call call = startRecordingValidateBeforeCall(id, startRecordingBody, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call startRecordingAsync(String id, StartRecordingBody startRecordingBody, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = startRecordingValidateBeforeCall(id, startRecordingBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param id The connection ID of the call. (required)
     * @param stopRecordingBody Request parameters. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call stopRecordingCall(String id, StopRecordingBody stopRecordingBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = stopRecordingBody;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call stopRecordingValidateBeforeCall(String id, StopRecordingBody stopRecordingBody, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = stopRecordingCall(id, stopRecordingBody, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse stopRecording(String id, StopRecordingBody stopRecordingBody) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = stopRecordingWithHttpInfo(id, stopRecordingBody);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call stopRecordingAsync(String id, StopRecordingBody stopRecordingBody, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = stopRecordingValidateBeforeCall(id, stopRecordingBody, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Switch to coach
     * Switch to the coach monitoring mode. When coaching is enabled and the agent receives a call, the supervisor is brought into the call. Only the agent can hear the supervisor.
     * @param id The connection ID of the call being monitored. (required)
     * @param monitoringScopeData  (optional)
     * @return ApiSuccessResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
    ...
    /**
     * Switch to listen in (asynchronously)
     * Switch to the listen in monitoring mode. When listen in is enabled and the agent receives a call, the supervisor is able to listen to the agent and the customer, but they can&#39;t hear the supervisor.
     * @param id The connection ID of the call being monitored. (required)
     * @param monitoringScopeData  (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateUserDataCall(String id, UserDataOperationId userData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = userData;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateUserDataValidateBeforeCall(String id, UserDataOperationId userData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse updateUserData(String id, UserDataOperationId userData) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> updateUserDataWithHttpInfo(String id, UserDataOperationId userData) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateUserDataAsync(String id, UserDataOperationId userData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
