...
import com.genesys.internal.workspace.model.CancelConsultData1;
import com.genesys.internal.workspace.model.GetDetailsData;
...
public class WorkbinsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getInteractionDetailsFromWorkbinCall(String interactionId, GetDetailsData getDetailsData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = getDetailsData;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getInteractionDetailsFromWorkbinValidateBeforeCall(String interactionId, GetDetailsData getDetailsData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getInteractionDetailsFromWorkbinCall(interactionId, getDetailsData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse getInteractionDetailsFromWorkbin(String interactionId, GetDetailsData getDetailsData) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getInteractionDetailsFromWorkbinAsync(String interactionId, GetDetailsData getDetailsData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getInteractionDetailsFromWorkbinValidateBeforeCall(interactionId, getDetailsData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getWorkbinsCall(CancelConsultData1 cancelConsultData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getWorkbinsValidateBeforeCall(CancelConsultData1 cancelConsultData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getWorkbinsCall(cancelConsultData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse getWorkbins(CancelConsultData1 cancelConsultData) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = getWorkbinsWithHttpInfo(cancelConsultData);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> getWorkbinsWithHttpInfo(CancelConsultData1 cancelConsultData) throws ApiException {
        com.squareup.okhttp.Call call = getWorkbinsValidateBeforeCall(cancelConsultData, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getWorkbinsAsync(CancelConsultData1 cancelConsultData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getWorkbinsValidateBeforeCall(cancelConsultData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
