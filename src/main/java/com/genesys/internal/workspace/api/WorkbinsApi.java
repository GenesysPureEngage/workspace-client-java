...
public class WorkbinsApi {
    ...
    public ApiSuccessResponse pullInteractionFromWorkbin(String workbinId, PullInteractionFromWorkbinData pullInteractionFromWorkbinData) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = pullInteractionFromWorkbinWithHttpInfo(workbinId, pullInteractionFromWorkbinData);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> pullInteractionFromWorkbinWithHttpInfo(String workbinId, PullInteractionFromWorkbinData pullInteractionFromWorkbinData) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call pullInteractionFromWorkbinAsync(String workbinId, PullInteractionFromWorkbinData pullInteractionFromWorkbinData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
