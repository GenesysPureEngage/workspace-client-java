...
public class SessionApi {
     ...
     * @param names list of object names seperate by coma. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getObjectsCall(String type, String names, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/configuration/{type}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getObjectsValidateBeforeCall(String type, String names, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling getObjects(Async)");
        }
        
        // verify the required parameter 'names' is set
        if (names == null) {
            throw new ApiException("Missing the required parameter 'names' when calling getObjects(Async)");
        }
        

        com.squareup.okhttp.Call call = getObjectsCall(type, names, progressListener, progressRequestListener);
        return call;

    }

    /**
     * Get list of objects describes by type and names
     * Get list of objects describes by type and names
     * @param type Type of object (required)
     * @param names list of object names seperate by coma. (required)
     * @return ApiSuccessResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse getObjects(String type, String names) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = getObjectsWithHttpInfo(type, names);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> getObjectsWithHttpInfo(String type, String names) throws ApiException {
        com.squareup.okhttp.Call call = getObjectsValidateBeforeCall(type, names, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get list of objects describes by type and names (asynchronously)
     * Get list of objects describes by type and names
     * @param type Type of object (required)
     * @param names list of object names seperate by coma. (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getObjectsAsync(String type, String names, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getObjectsValidateBeforeCall(type, names, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call initializeWorkspaceCall(String code, String redirectUri, String state, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call initializeWorkspaceValidateBeforeCall(String code, String redirectUri, String state, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = initializeWorkspaceCall(code, redirectUri, state, authorization, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse initializeWorkspace(String code, String redirectUri, String state, String authorization) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> initializeWorkspaceWithHttpInfo(String code, String redirectUri, String state, String authorization) throws ApiException {
        com.squareup.okhttp.Call call = initializeWorkspaceValidateBeforeCall(code, redirectUri, state, authorization, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call initializeWorkspaceAsync(String code, String redirectUri, String state, String authorization, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
