...
import com.genesys.internal.workspace.model.ChannelsData1;
import com.genesys.internal.workspace.model.ChannelsData2;
...
public class SessionApi {
    ...
    /**
     * Activate channels (asynchronously)
     * Activate the specified channels using the provided resources. If the channels are successfully activated, Workspace sends additional information about the state of active resources (DNs, channels) via events. The resources you provide are associated with the agent for the duration of the session. You should send this request after making an [/initialize-workspace](/reference/workspace/Session/index.html#initializeWorkspace) request and getting the WorkspaceInitializationComplete message through CometD.
     * @param channelsData  (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call activateMediaCall(ChannelsData2 channelsData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = channelsData;

        // create path and map variables
        String localVarPath = "/media/activate";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call activateMediaValidateBeforeCall(ChannelsData2 channelsData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'channelsData' is set
        if (channelsData == null) {
            throw new ApiException("Missing the required parameter 'channelsData' when calling activateMedia(Async)");
        }
        

        com.squareup.okhttp.Call call = activateMediaCall(channelsData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse activateMedia(ChannelsData2 channelsData) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = activateMediaWithHttpInfo(channelsData);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> activateMediaWithHttpInfo(ChannelsData2 channelsData) throws ApiException {
        com.squareup.okhttp.Call call = activateMediaValidateBeforeCall(channelsData, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Activate open media channels (asynchronously)
     * Activate the specified channels using the provided resources. You can only send this request if you have already made an [/activate-channels](/reference/workspace/Session/index.html#activateChannels) request.
     * @param channelsData  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call activateMediaAsync(ChannelsData2 channelsData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = activateMediaValidateBeforeCall(channelsData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for activateVoice
     * @param channelsData  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call activateVoiceCall(ChannelsData1 channelsData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = channelsData;

        // create path and map variables
        String localVarPath = "/voice/activate";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call activateVoiceValidateBeforeCall(ChannelsData1 channelsData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'channelsData' is set
        if (channelsData == null) {
            throw new ApiException("Missing the required parameter 'channelsData' when calling activateVoice(Async)");
        }
        

        com.squareup.okhttp.Call call = activateVoiceCall(channelsData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse activateVoice(ChannelsData1 channelsData) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = activateVoiceWithHttpInfo(channelsData);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> activateVoiceWithHttpInfo(ChannelsData1 channelsData) throws ApiException {
        com.squareup.okhttp.Call call = activateVoiceValidateBeforeCall(channelsData, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Activate voice channel (asynchronously)
     * Activate the voice channel using the provided resources. You can only send this request if you have already made an [/activate-channels](/reference/workspace/Session/index.html#activateChannels) request.
     * @param channelsData  (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call activateVoiceAsync(ChannelsData1 channelsData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = activateVoiceValidateBeforeCall(channelsData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for deactivateMedia
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deactivateMediaCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/media/deactivate";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deactivateMediaValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = deactivateMediaCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse deactivateMedia() throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = deactivateMediaWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> deactivateMediaWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = deactivateMediaValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Deactivate open media channels (asynchronously)
     * Deactivate the open media channels.
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deactivateMediaAsync(final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deactivateMediaValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for deactivateVoice
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deactivateVoiceCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/voice/deactivate";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deactivateVoiceValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = deactivateVoiceCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse deactivateVoice() throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = deactivateVoiceWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> deactivateVoiceWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = deactivateVoiceValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Deactivate voice channel (asynchronously)
     * Deactivate the voice channel.
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deactivateVoiceAsync(final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deactivateVoiceValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Get business attribute hierarchy (asynchronously)
     * Get the business attribute hierarchy for the specified business attribute.
     * @param id The unique ID of the business attribute. (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Get configuration settings (asynchronously)
     * Get all configuration items needed by the user interface. This includes action codes, business attributes, transactions, and settings.
     * @param types A comma delimited list of types used to specify what content should be returned. If not specified the default is &#x60;actionCodes, agentGroups,settings&#x60;. Valid values are &#x60;actionCodes&#x60;, &#x60;agentGroups&#x60;, &#x60;settings&#x60;, &#x60;workspaceTransactions&#x60;, and &#x60;businessAttributes&#x60;. (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     * @param placeStatus Return the information if place is used by an agent. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getDevicesForPlaceCall(String placeName, Boolean placeStatus, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (placeStatus != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("placeStatus", placeStatus));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getDevicesForPlaceValidateBeforeCall(String placeName, Boolean placeStatus, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getDevicesForPlaceCall(placeName, placeStatus, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Devices getDevicesForPlace(String placeName, Boolean placeStatus) throws ApiException {
        ApiResponse<Devices> resp = getDevicesForPlaceWithHttpInfo(placeName, placeStatus);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Devices> getDevicesForPlaceWithHttpInfo(String placeName, Boolean placeStatus) throws ApiException {
        com.squareup.okhttp.Call call = getDevicesForPlaceValidateBeforeCall(placeName, placeStatus, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getDevicesForPlaceAsync(String placeName, Boolean placeStatus, final ApiCallback<Devices> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getDevicesForPlaceValidateBeforeCall(placeName, placeStatus, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Devices>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param optimizeConfig This parameter allows to activate optimize config mode. When this mode is activated the content of some event is modified and format about KVPList. (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call initializeWorkspaceCall(String code, String redirectUri, String state, Boolean optimizeConfig, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("optimize_config", optimizeConfig));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call initializeWorkspaceValidateBeforeCall(String code, String redirectUri, String state, Boolean optimizeConfig, String authorization, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = initializeWorkspaceCall(code, redirectUri, state, optimizeConfig, authorization, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse initializeWorkspace(String code, String redirectUri, String state, Boolean optimizeConfig, String authorization) throws ApiException {
        ApiResponse<ApiSuccessResponse> resp = initializeWorkspaceWithHttpInfo(code, redirectUri, state, optimizeConfig, authorization);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> initializeWorkspaceWithHttpInfo(String code, String redirectUri, String state, Boolean optimizeConfig, String authorization) throws ApiException {
        com.squareup.okhttp.Call call = initializeWorkspaceValidateBeforeCall(code, redirectUri, state, optimizeConfig, authorization, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get and register an auth token (asynchronously)
     * Retrieve the authorization token using the authorization code. Workspace then registers the token and prepares the user&#39;s environment.
     * @param code The authorization code. You must include this parameter for the [Authorization Code Grant flow](/reference/authentication/). (optional)
     * @param redirectUri The same redirect URI you used in the initial login step. You must include this parameter for the [Authorization Code Grant flow](/reference/authentication/). (optional)
     * @param state The state parameter provide by the auth service on redirect that should be used to validate. This parameter must be provided if the include_state parameter is sent with the /login request. (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call initializeWorkspaceAsync(String code, String redirectUri, String state, Boolean optimizeConfig, String authorization, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = initializeWorkspaceValidateBeforeCall(code, redirectUri, state, optimizeConfig, authorization, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call loginCall(String redirectUri, String type, String locale, Boolean includeState, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call loginValidateBeforeCall(String redirectUri, String type, String locale, Boolean includeState, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = loginCall(redirectUri, type, locale, includeState, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void login(String redirectUri, String type, String locale, Boolean includeState) throws ApiException {
        loginWithHttpInfo(redirectUri, type, locale, includeState);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> loginWithHttpInfo(String redirectUri, String type, String locale, Boolean includeState) throws ApiException {
        com.squareup.okhttp.Call call = loginValidateBeforeCall(redirectUri, type, locale, includeState, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call loginAsync(String redirectUri, String type, String locale, Boolean includeState, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = loginValidateBeforeCall(redirectUri, type, locale, includeState, progressListener, progressRequestListener);
    ...
    /**
     * Log out and end the session (asynchronously)
     * End the current agent&#39;s session. This request logs out the agent on all activated channels, ends the HTTP session, and cleans up related resources. Genesys recommends that you first disconnect CometD and then make this request. After you end the session, you&#39;ll need to make a login request before making any new calls to the API.
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
