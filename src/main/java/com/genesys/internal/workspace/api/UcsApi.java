...
import com.genesys.internal.workspace.model.CompletedData;
...
import com.genesys.internal.workspace.model.DeletelData;
import com.genesys.internal.workspace.model.EsSearchInteractionData;
import com.genesys.internal.workspace.model.FindOrCreateData;
...
import com.genesys.internal.workspace.model.LuceneIndexesData;
...
public class UcsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteContactCall(String id, DeletelData deletelData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = deletelData;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteContactValidateBeforeCall(String id, DeletelData deletelData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteContactCall(id, deletelData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse deleteContact(String id, DeletelData deletelData) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> deleteContactWithHttpInfo(String id, DeletelData deletelData) throws ApiException {
        com.squareup.okhttp.Call call = deleteContactValidateBeforeCall(id, deletelData, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteContactAsync(String id, DeletelData deletelData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteContactValidateBeforeCall(id, deletelData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call findOrCreatePhoneCallCall(String id, FindOrCreateData findOrCreateData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = findOrCreateData;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call findOrCreatePhoneCallValidateBeforeCall(String id, FindOrCreateData findOrCreateData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = findOrCreatePhoneCallCall(id, findOrCreateData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiSuccessResponse findOrCreatePhoneCall(String id, FindOrCreateData findOrCreateData) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ApiSuccessResponse> findOrCreatePhoneCallWithHttpInfo(String id, FindOrCreateData findOrCreateData) throws ApiException {
        com.squareup.okhttp.Call call = findOrCreatePhoneCallValidateBeforeCall(id, findOrCreateData, null, null);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call findOrCreatePhoneCallAsync(String id, FindOrCreateData findOrCreateData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = findOrCreatePhoneCallValidateBeforeCall(id, findOrCreateData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getLuceneIndexesCall(LuceneIndexesData luceneIndexesData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = luceneIndexesData;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getLuceneIndexesValidateBeforeCall(LuceneIndexesData luceneIndexesData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getLuceneIndexesCall(luceneIndexesData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ConfigResponse> getLuceneIndexesWithHttpInfo(LuceneIndexesData luceneIndexesData) throws ApiException {
        com.squareup.okhttp.Call call = getLuceneIndexesValidateBeforeCall(luceneIndexesData, null, null);
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call setCompletedCall(String id, CompletedData completedData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = completedData;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call setCompletedValidateBeforeCall(String id, CompletedData completedData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = setCompletedCall(id, completedData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call setCompletedAsync(String id, CompletedData completedData, final ApiCallback<ApiSuccessResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = setCompletedValidateBeforeCall(id, completedData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ApiSuccessResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
